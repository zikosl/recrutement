                            ...
                            <tbody>
                                    <tr>
                                      <td>
                                          <div class="job-info f-saira">
                                                ...
                                                <p><span><i class="slimi-icon slimi-placeholder"></i>Netherlands, Rotterdam</span><span><i class="slimi-icon slimi-design-skills"></i>Web Developer</span></p>
                                          </div>
                                          </td>
                                      <td><p class="job-app">(3+) Applied</p></td>
                                      <td>
                                        <div class="job-info f-quick">
                                          <p><i class="slimi-icon slimi-time"></i>Created: <span class="dat">24, 2018</span></p>
                                          <p><i class="slimi-icon slimi-time"></i>Expiry: <span class="dat">19, 2018</span></p>
                                        </div>
                                      </td>
                                      <td class="statu job-act"><i class="fas fa-circle"></i>Active</td>
                                      <td><div class="mng-job-link">
                                            <a href="#" class="slimi-icon slimi-view"></a>
                                            <a href="#" class="slimi-icon slimi-edit"></a>
                                            <a href="#" class="slimi-icon slimi-rubbish"></a>
                                        </div>
                                      </td>
                                    </tr>
                                    <tr>
                                            <td>
                                                ...
                                                <td>
                                                  <div class="job-info f-quick">
                                                    <p><i class="slimi-icon slimi-time"></i>Created: <span class="dat">14, 2017</span></p>
                                                    <p><i class="slimi-icon slimi-time"></i>Expiry: <span class="dat">9, 2017</span></p>
                                                  </div>
                                                </td>
                                                <td class="statu job-exp"><i class="fas fa-circle"></i>Experied</td>
                                                <td><div class="mng-job-link">
                                                      <a href="#" class="slimi-icon slimi-view"></a>
                                                      <a href="#" class="slimi-icon slimi-edit"></a>
                                                      <a href="#" class="slimi-icon slimi-rubbish"></a>
                                    ...
                                    <tr>
                                            <td>
                                                ...
                                                <td>
                                                  <div class="job-info f-quick">
                                                    <p><i class="slimi-icon slimi-time"></i>Created: <span class="dat">10, 2019</span></p>
                                                    <p><i class="slimi-icon slimi-time"></i>Expiry: <span class="dat">22, 2016</span></p>
                                                  </div>
                                                </td>
                                                <td class="statu job-pan"><i class="fas fa-circle"></i>Suspondu</td>
                                                <td><div class="mng-job-link">
                                                      <a href="#" class="slimi-icon slimi-view"></a>
                                                      <a href="#" class="slimi-icon slimi-edit"></a>
                                                      <a href="#" class="slimi-icon slimi-rubbish"></a>
