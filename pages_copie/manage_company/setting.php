    ...
    <div class='row'>
        ...
        <div class="col-lg-8 pl-lg-4">
          <div class="p-3 comp-info mt-5">
            <div class="h2 f-quick f-500 text-indigo"><i class="slimi-icon slimi-buildings2"></i>Welcome Company</div>
            <div class="dropdown-divider mt-4"></div>
            <div class="row my-5">
                <div class="col-lg-6">
                            <div class="form-group f-quick">
                                        <label class="f-open f-15" for="user">Company Name</label>
                                        <input type="text" id="user" class="form-control custom-in" placeholder="Tera Planer">
                            </div>
               </div>
               <div class="col-lg-6">
                  <div class="form-group f-quick">
                              <label class="f-open f-15" for="user">Allow In Search</label>
                              <input type="text" id="user" class="form-control custom-in" placeholder="True">
                  </div>
                </div>
            </div>
            <div class="row my-5">
                <div class="col-lg-6">
                            <div class="form-group f-quick">
                                        <label class="f-open f-15" for="user">Founded Date</label>
                                        <input type="text" id="user" class="form-control custom-in" placeholder="10/11/1956">
                            </div>
               </div>
               <div class="col-lg-6">
                  <div class="form-group f-quick">
                              <label class="f-open f-15" for="user">Team Number</label>
                              <input type="text" id="user" class="form-control custom-in" placeholder="100">
                  </div>
                </div>
            </div>
            <div class="row my-5">
        ...
        <div class="p-3 comp-info mt-5">
          ...
          <div class="row mt-5 mb-3">
              <div class="col-lg-6">
                          <div class="form-group f-quick">
                                      <label class="f-open f-15" for="user">Phone Number</label>
                                      <div class="custom-in">
                                          <input type="text" id="user" placeholder="+22064711025">
             ...
             <div class="col-lg-6">
                <div class="form-group f-quick">
                            ...
                            <div class="custom-in">
                                <input type="text" id="user" placeholder="exempl@user.com">
          ...
          <div class="row mb-5">
              <div class="col-lg-6 offset-lg-3">
                  <div class="form-group f-quick">
                              <label class="f-open f-15" for="user">Website</label>
                              <div class="custom-in">
                                  <input type="text" id="user" placeholder="www.exemple.com">
