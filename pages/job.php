...
else
{
 ...
 ?>
 <?php
 require_once $_SERVER['DOCUMENT_ROOT'].'\recrutment\pages\php_verif\manage_user_profile\test_short.php';
 ?>
<head>
    <meta charset="UTF-8">
  ...
  <div class="row m-auto">
      <div class="col-lg-12">
        <div class="emplo-detail d-flex justify-content-between">
              ...
              <div class="emplo-info">
                    <span class="<?php echo $job->get_job_css();?> ml-0"><?php echo $job->get_type_j();?></span> <span class="job-sall f-quick f-500">Offred Salary: <?php echo $job->get_sale();?><small>.00</small> $</span>
                    <form action="<?php echo$_SERVER['REQUEST_URI'];?>" method="post"><button name="shortlist" class="jobs-listed"><i class="<?php if($flw){echo "fas";}else{echo "far";}?> fa-bookmark"></i></button></form>
                    <h3 class="f-robot f-700"><?php echo $job->get_title();?></h3>
                    <ul>
                        <li><i class="slimi-icon slimi-placeholder"></i ><?php echo ucfirst($emp->get_region()).", ".ucfirst($emp->get_country());?></li>
                        <li><i class="slimi-icon slimi-building"></i><?php echo $job->get_categorie();?></li>
                        <li><i class="slimi-icon slimi-view"></i> Views 5683</li>
                    </ul>
                    <ul>
                            <li><i class="slimi-icon slimi-time"></i> Post Date: <?php echo $job->get_post_date();?></li>
                            <li><i class="slimi-icon slimi-time"></i> Last Date: <?php echo $job->get_last_view();?></li>
                    </ul>
                    <div class="mt-4">
                       <button class="btn btn-warning text-white f-quick f-500"><i class="slimi-icon slimi-mail"></i> Apply Job</button>
                    <span class="mx-2 f-source sct">Share this Job:</span>
                    <ul class="icon-shar">
                            <a href="http://<?php echo $emp->get_google();?>"><li><i class="fab fa-google-plus-g"></i></li></a>
                            <a href="http://<?php echo $emp->get_fb();?>"><li><i class="fab fa-facebook-f"></i></li></a>
                            <a href="http://<?php echo $emp->get_twitter();?>"><li><i class="fab fa-twitter"></i></li></a>
                            <a href="http://<?php echo $emp->get_linked();?>"><li><i class="fab fa-linkedin-in"></i></li></a>
                    </ul> 
                    </div>
  ...
  <div class="row m-auto">
      <div class="col-lg-8 px-0">
          <div class="company-about px-3 border-s shadow-sm py-4">   
           ...
           <?php
            $x=html_entity_decode($job->get_dscrpt());
           ...
           <div class="my-3 tags f-saira">
                ...
                <?php foreach($job->get_skill_array() as $j)
                {
                    echo '<a href="#">'.ucfirst($j).'</a>';
                }
                ?>
           </div>
      </div>
                        ...
                        <ul>
                                <li>
                                    <i class="slimi-icon slimi-salary"></i>
                                        <h6>Offerd Salary</h6>
                                        <span><?php echo "$ ".$job->get_sale();?></span>
                                </li>
                                <li>
                                    <i class="slimi-icon slimi-group"></i>
                                        <h6>Career Level</h6>
                                        <span><?php echo $job->get_career_str();?></span>
                                </li>
                                <li>
                                    <i class="slimi-icon slimi-briefcase"></i>
                                        <h6>Experience</h6>
                                        <span><?php echo $job->get_experience();?> Years</span>
                                </li>
                                <li>
                                    <i class="slimi-icon slimi-user"></i>
                                        <h6>Gender</h6>
                                        <span><?php if($job->get_gender()==0) echo 'Male'; else echo'Female';?></span>
                                </li>
                                <li>
                                    <i class="slimi-icon slimi-internet"></i>
                                        <h6>Language</h6>
                                        <span><?php echo $job->get_lang_str();?></span>
                                </li>
                                <li>
                                    <i class="slimi-icon slimi-mortarboard"></i>
                                        <h6>Qualification</h6>
                                        <span><?php echo $job->get_qual();?></span>
                                </li>
                            </ul>
            </div>
