...
.custom-in
    ...
    .card-info .us-img>img
    {
        border-radius: 100%
    }
    .card-info figcaption
    {
        margin-left: 58px;
    }
    .card-info .us_n
    ...
    .card-info figure .li_te a
    {
        color: #444;
        text-decoration:none !important; 
    }
    .card-info figure .li_te i
    {
        color: #ff2289;
        font-size: 19px;
        margin-right: 5px;
    }
    .card-info figure .re i
    {
                    ...
                    <div class="rsm mt-5">
                            <div class="row mx-auto">
                                <div class="col-lg-7 pl-3">
                                    <div class="h3 f-quick f-500 text-indigo"><i class="slimi-icon slimi-graphic"></i>Shortlisted Resumes</div>
                                </div>
                        ...
                        <div class="row mx-auto">
                            <?php foreach ($rsm as $f)
                            { ?>
                            <div class="col-lg-6">
                                <div class="card-info">
                                <figure>
                                   <a class="us-img">
                                    <img src="<?php echo$f->get_pic();?>" width="100%" alt="" srcset="">
                                    </a>
                                <figcaption>
                                    <div class="d-flex justify-content-between">
                                      <div class="us_n">
                                        <h5><?php echo $f->get_first().' '.$f->get_last();?></h5>
                                        <p>Web Developer at <span>Vivatam</span></p>
                                      </div>
                                      <div class="d-cv"><a href="">Download CV<i class="slimi-icon slimi-download-arrow"></i></a></div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                       <div class="mp_sl"> 
                                         <p>Location:</p>
                                         <div><?php echo $f->get_region()." , ".$f->get_country();?></div>
                                       </div>
                                        <div class="mp_sl"> 
                                            <p>Current Salary:</p>
                                            <div>$<?php echo$f->get_c_sale();?>/p.a minimum</div>
                                        </div>
                                    </div>
                                </figcaption>  
                               <div class="d-flex justify-content-between">
                                    <div class="li_te w-75">
                                            <a href="">
                                                  <i class="la la-unlink"></i>
                                                  Save Resume
                                            </a>
                                    </div>
                                    <div class="li_te re w-25 text-right">
                                            <a href="">
                                 ...
                                 <ul>
                                     <a href="http://localhost/recrutment/pages/condidat.php?user=<?php echo $f->get_id($id);?>#contact_user" target="_blank"><li><i class="slimi-icon slimi-mail"></i>Message</li></a>
                                     <a href="http://localhost/recrutment/pages/condidat.php?user=<?php echo $f->get_id($id);?>" target="_blank"><li><i class="slimi-icon slimi-user-1"></i>View profile</li></a>
                                     <li><i class="slimi-icon slimi-linkedin-1"></i>Linked</li>
                                 </ul>
                                </div>
                            </div>
                            <?php }?>
