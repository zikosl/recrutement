<?php require_once "php_verif/manage_log_register/log.php";?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="jumbotron">
  <div class="container">
    <h2 class="f-raleway font-weight-bold text-center mx-auto my-4 ls-1" >Login Form</h2>   
...
<div class="f-quick form-log"> 
  <form action='<?php echo $_SERVER["PHP_SELF"];?>' method="post">
    ...
    <div class="form-group">
      <input type="email" name='mail' class="form-control custom-in f-500" aria-describedby="emailHelp" placeholder="Enter email">
    ...
    <div class="gol-g">
    <div class="form-group">
      <input type="password" id="pass" name="pass" class="form-control custom-in f-500" placeholder="*********">
    ...
    <div class="row mx-auto mt-3 text-center">
     ...
     <div class="form-group form-check  float-left p-0 mt-1 checkbox pi">
      ...
      <label class="form-check-label f-500" style="font-size: 14px;" for="exampleCheck1">Remembre Me</label>
    </div>
      </div>
      <div class="col-6">
        <a href="forget.php" class="link_cus f-500">Forget password</a>
      </div>
    </div>
